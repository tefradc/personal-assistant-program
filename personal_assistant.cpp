...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning tefradc"<<endl;
        string phrase = "Good Morning tefra d c";
        ...
        cout<< "Good Afternoon tefradc"<<endl;
        string phrase = "Good Afternoon tefra d c";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening tefradc"<<endl;
        string phrase = "Good Evening tefra d c";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE TEFRADC|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE TEFRA D C";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="tefradc")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you tefra d c...."<<endl<<endl;

                string phrase = "How can i help you tefra d c";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello tefradc....."<<endl;
                    string phrase = "Hello tefra d c";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by tefradc !!!"<<endl;
                    string phrase = "I'm a personal assistant created by tefradc !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="play music")
                {
                    ...
                    // mciSendString("play mp3", NULL, 0, NULL);
                     ShellExecute(NULL,"open","Lokiverse.mp3",NULL, NULL, SW_NORMAL);
                }
                ...
                {
                    cout<<"Good Bye tefradc, see you soon!"<<endl;
                    string phrase = "Good Bye tefra d c, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
